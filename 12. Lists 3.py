...
print ('We will get 5 random words to fill the brackets.\nYou have to type from 0 to 5 to get a random word for each bracket.\n"0" will represent the first word and "5" the last word of a "secret list".')

word1 = list_1[int(input("\nType from 0 to 5 to get a word from secret list 1: "))]
word2 = list_2[int(input("Type from 0 to 5 to get a word from secret list 2: "))]
word3 = list_3[int(input("Type from 0 to 5 to get a word from secret list 3: "))]
word4 = list_4[int(input("Type from 0 to 5 to get a word from secret list 4: "))]
word5 = list_5[int(input("Type from 0 to 5 to get a word from secret list 5: "))]

print ("")

print (f"Twas {word1.upper()}, and the {word2.upper()} toves Did gyre and {word3.upper()} in the wabe: All {word4.upper()} were the borogoves, And the {word5.upper()} raths outgrabe.\n")
